...
import DownloadForm, { DownloadFormRef, DownloadFormType } from "@/components/DownloadForm";
...
export function DownloadList({ data, filter, refresh, loading, pagination }: Props) {
  ...
  useEffect(() => {
    ...
    const onDownloadMenuEvent = async (e: unknown, params: { action: string; payload: number }) => {
