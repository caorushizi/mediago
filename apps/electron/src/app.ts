...
import { DownloaderService, TaskQueueService, TYPES } from "@mediago/shared/node";
import { Menu, Tray, app, nativeImage, nativeTheme, Event, BrowserWindow } from "electron";
